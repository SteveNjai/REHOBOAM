...
1.  **Generate price\_history.csv**:
    ...
    *   Run create\_price\_history.py to merge MT5-exported CSVs (e.g., XAUUSD.csv, XAGUSD.csv) into price\_history.csv.
        
    *   Ensure 1–3 years of hourly data (~12,000–36,000 bars).
        
2.  D:\\PROJECTS\\BOTS\\REHOBOAM\\rehoboam-tools\\Scripts\\python.exe D:\\PROJECTS\\BOTS\\REHOBOAM\\rehoboam-tools\\cointegration\_screen.py
