...
class MarkovSwitching(tsbase.TimeSeriesModel):
    ...
    def predict(self, params, start=None, end=None, probabilities=None,
        ...
        ----------
        params : ndarray
            Parameters at which to form zscore_predictor_results
        ...
        conditional : bool or int, optional
            Whether or not to return zscore_predictor_results conditional on current or
            past regimes. If False, returns a single vector of weighted
            zscore_predictor_results. If True or 1, returns zscore_predictor_results conditional on the
            current regime. For larger integers, returns zscore_predictor_results
    ...
    def predict_conditional(self, params):
        ...
        -------
        predict : array_like
            Array of zscore_predictor_results conditional on current, and possibly past,
            regimes
        """
        raise NotImplementedError
