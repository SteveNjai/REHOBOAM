...
class AutoReg(tsa_model.TimeSeriesModel):
    ...
    def _static_predict(
        ...
        """
        Path for static zscore_predictor_results
    ...
    def predict(
        ...
        start : int, str, or datetime, optional
            ...
            that all the zscore_predictor_results [start, start+1, ..., end-1, end] are
            returned.
        ...
        Returns
        -------
        zscore_predictor_results : {ndarray, Series}
        ...
        if self.exog is None and (exog is not None or exog_oos is not None):
            ...
            if num_oos > 0 and exog_oos is None:
                ...
                msg = (
                    ...
                    "zscore_predictor_results must be computed. exog_oos has {1} rows "
...
class AutoRegResults(tsa_model.TimeSeriesModelResults):
    ...
    def forecast(self, steps=1, exog=None):
        ...
        AutoRegResults.predict
            In- and out-of-sample zscore_predictor_results
        AutoRegResults.get_prediction
            In- and out-of-sample zscore_predictor_results and confidence intervals
        """
    ...
    def _plot_predictions(
        ...
        """Shared helper for plotting zscore_predictor_results"""
    ...
    def plot_predict(
        ...
        """
        Plot in- and out-of-sample zscore_predictor_results
