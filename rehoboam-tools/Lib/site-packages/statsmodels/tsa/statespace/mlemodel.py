...
class MLEResults(tsbase.TimeSeriesModelResults):
    ...
    def get_prediction(self, start=None, end=None, dynamic=False,
        ...
        information_set : str, optional
            ...
            "predicted", which computes zscore_predictor_results of period t values
            conditional on observed data through period t-1; these are
            one-step-ahead zscore_predictor_results, and correspond with the typical
            `fittedvalues` results attribute. Alternatives are "filtered",
            which computes zscore_predictor_results of period t values conditional on
            observed data through period t, and "smoothed", which computes
            zscore_predictor_results of period t values conditional on the entire dataset
            (including also future observations t+1, t+2, ...).
        signal_only : bool, optional
            Whether to compute zscore_predictor_results of only the "signal" component of
            ...
            True, then zscore_predictor_results of the "signal" :math:`Z \alpha_t` will be
            returned. Otherwise, the default is for zscore_predictor_results of :math:`y_t`
            to be returned.
        **kwargs
        ...
        Returns
        -------
        zscore_predictor_results : PredictionResults
            PredictionResults instance containing in-sample zscore_predictor_results /
        ...
        predict
            In-sample zscore_predictor_results and out-of-sample forecasts.
        get_forecast
            Out-of-sample forecasts and results including confidence intervals.
        """
        if start is None:
    ...
    def get_forecast(self, steps=1, signal_only=False, **kwargs):
        ...
        **kwargs
        ...
        predict
            In-sample zscore_predictor_results and out-of-sample forecasts.
        get_prediction
            In-sample zscore_predictor_results / out-of-sample forecasts and results
    ...
    def predict(self, start=None, end=None, dynamic=False,
        ...
        **kwargs
        ...
        Returns
        -------
        zscore_predictor_results : array_like
            In-sample zscore_predictor_results / Out-of-sample forecasts. (Numpy array or
    ...
    def get_smoothed_decomposition(self, decomposition_of='smoothed_state',
        ...
        decomposition_of : {"smoothed_state", "smoothed_signal"}
            ...
            is set to "smoothed_signal", then the zscore_predictor_results of the
