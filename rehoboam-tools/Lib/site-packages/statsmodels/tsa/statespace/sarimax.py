...
class SARIMAX(MLEModel):
    ...
    **kwargs
    ...
    - Forecasts and zscore_predictor_results will be about the *differenced* data, not about
      the original data. (while if `simple_differencing = False` is used, then
      forecasts and zscore_predictor_results will be about the original data).
    - If the original data has an Int64Index, a new RangeIndex will be created
      ...
      zscore_predictor_results will use this new index.
