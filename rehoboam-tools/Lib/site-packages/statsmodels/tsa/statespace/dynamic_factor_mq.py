...
class DynamicFactorMQ(mlemodel.MLEModel):
    ...
    **Standardizing data**
    ...
    as in-sample zscore_predictor_results, out-of-sample forecasts, and the computation of
    ...
    *Impulse responses*
    ...
    def simulate(self, params, nsimulations, measurement_shocks=None,
        ...
        # If applicable, convert zscore_predictor_results back to original space
...
class DynamicFactorMQResults(mlemodel.MLEResults):
    ...
    def get_prediction(self, start=None, end=None, dynamic=False,
        ...
        original_scale : bool, optional
            If the model specification standardized the data, whether or not
            to return zscore_predictor_results in the original scale of the data (i.e.
            before it was standardized by the model). Default is True.
        **kwargs
        ...
        -------
        forecast : ndarray
            Array of out of in-sample zscore_predictor_results and / or out-of-sample
            forecasts. An (npredict x k_endog) array.
        """
        # Get usual zscore_predictor_results (in the possibly-standardized scale)
