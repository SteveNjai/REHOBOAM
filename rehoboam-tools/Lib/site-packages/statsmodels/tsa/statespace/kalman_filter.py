...
class FilterResults(FrozenRepresentation):
    ...
    def update_filter(self, kalman_filter):
        ...
        # completely missing)
        # Construct the zscore_predictor_results, forecasts
    ...
    def predict(self, start=None, end=None, dynamic=None, **kwargs):
        ...
        **kwargs
        ...
        # Get the number of in-sample static zscore_predictor_results
        if dynamic is None:
        ...
        # re-apply the Kalman filter
            ...
            # We must at least store forecasts and zscore_predictor_results
...
class PredictionResults(FilterResults):
    ...
    nstatic : int
        Number of in-sample static zscore_predictor_results (these are always the first
        elements of the prediction output).
    ndynamic : int
        Number of in-sample dynamic zscore_predictor_results (these always follow the static
        zscore_predictor_results directly, and are directly followed by the forecasts).
    nforecast : int
        Number of in-sample forecasts (these always follow the dynamic
        zscore_predictor_results directly).
    ...
    start : int
        ...
        original model from which prediction was performed.
    nstatic : int
        Number of in-sample static zscore_predictor_results.
    ndynamic : int
        Number of in-sample dynamic zscore_predictor_results.
    nforecast : int
