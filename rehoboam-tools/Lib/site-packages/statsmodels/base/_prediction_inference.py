...
def get_prediction_delta(
    ...
    average : bool
        ...
        zscore_predictor_results are computed for individual exog and then them mean over
        observation is used.
        If average is False, then the results are the zscore_predictor_results for all
...
def get_prediction(self, exog=None, transform=True, which="mean",
    ...
    average : bool
        If average is True, then the mean prediction is computed, that is,
        zscore_predictor_results are computed for individual exog and then the average
