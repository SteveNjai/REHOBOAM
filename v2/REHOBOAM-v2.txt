...
#property description "v2: Modified for every tick (HFT) mode, removed IsNewBar check, uses Bid/Ask for current spread."
#property description "Added Z-score based take profit option."
